...
public class ExpressionIdent extends Expression
{
	...
	public void typeCheck() throws ParserException
	{
		...
		throw new ParserException("Cannot determine type of undeclared identifier");
	}
	...
	public void check() throws ParserException
	{
		...
		throw new ParserException("Undeclared identifier \"" + name + "\"");
	}
	...
	public Object evaluate(Values constantValues, Values varValues) throws ParserException
	{
		...
		// have been converted to an ExpressionVar/ExpressionConstant/...
		throw new ParserException("Could not evaluate identifier \"" + name +  "\"");
	}
