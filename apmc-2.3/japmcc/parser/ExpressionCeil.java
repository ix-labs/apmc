...
public class ExpressionCeil extends ExpressionUnary
{
	// constructors
	
	public ExpressionCeil()
	{
	}

	public ExpressionCeil(Expression e)
	{
		super(e);
	}
	...
	{
		return new ExpressionCeil(operand.rename(rm));
	}
	...
	{
		return new ExpressionCeil(operand.expandConstants(constantList));
	}
	...
	{
		return new Integer((int)Math.ceil(getOperand().evaluateDouble(constantValues, varValues)));
	}
